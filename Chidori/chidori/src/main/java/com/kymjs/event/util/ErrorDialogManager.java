...
public class ErrorDialogManager {
    ...
    protected static final String TAG_ERROR_DIALOG = "com.kymjs.eventbus.error_dialog";
    protected static final String TAG_ERROR_DIALOG_MANAGER = "com.kymjs.eventbus.error_dialog_manager";

    public static final String KEY_TITLE = "com.kymjs.eventbus.errordialog.title";
    public static final String KEY_MESSAGE = "com.kymjs.eventbus.errordialog.message";
    public static final String KEY_FINISH_AFTER_DIALOG = "com.kymjs.eventbus.errordialog.finish_after_dialog";
    public static final String KEY_ICON_ID = "com.kymjs.eventbus.errordialog.icon_id";
    public static final String KEY_EVENT_TYPE_ON_CLOSE = "com.kymjs.eventbus.errordialog.event_type_on_close";
